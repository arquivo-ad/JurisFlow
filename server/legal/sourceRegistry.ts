...
export const INITIAL_LEGAL_SOURCE_REGISTRY: LegalSourceRegistryItem[] = [
  ...
  },
  {
    ...
    jurisdiction: 'BRASIL',
    sourceType: 'OFFICIAL_SEARCH',
    officialBaseUrl: 'https://sjur-pesquisa-api.tse.jus.br/tse/sjur-pesquisa-backend/rest/public/pesquisa',
    documentationUrl: 'https://www.tse.jus.br/jurisprudencia/pesquisa-de-jurisprudencia',
    connectorStatus: 'DEGRADED',
    coverageStatus: 'Jurisprudência 4.0 identificada. O frontend oficial habilita hCaptcha invisível e a API pública responde "Falha na verificação antirrobô" sem token; automação permanece fail-closed.',
  ...
  },
  {
    ...
    jurisdiction: 'BRASIL',
    sourceType: 'OFFICIAL_SEARCH',
    officialBaseUrl: 'https://acordaos.economia.gov.br/solr/acordaos2/browse/',
    documentationUrl: 'https://carf.fazenda.gov.br/jurisprudencia',
    connectorStatus: 'READY',
    coverageStatus: 'Acórdãos do contencioso administrativo tributário federal via Solr oficial, com reconfirmação individual por ID, PDF individual e SHA-256 do PDF extraído do envelope oficial.',
    verificationMethod: 'OPEN_DATA_DIGEST',
    termsStatus: 'COMPLIANT_PUBLIC_ACCESS',
    documentsDiscovered: 0,
    documentsFetched: 0,
